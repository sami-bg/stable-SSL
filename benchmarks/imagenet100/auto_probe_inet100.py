"""Offline linear probe evaluation for I-JEPA checkpoints on ImageNet-100.
...
Usage:
    python benchmarks/imagenet100/linear-probe-inet100.py
    python benchmarks/imagenet100/linear-probe-inet100.py --single /path/to/ckpt.ckpt
    python benchmarks/imagenet100/linear-probe-inet100.py --no-wandb
"""
...
def main():
    ...
    parser.add_argument("--single", type=str, default='/mnt/data/sami/stable-SSL/benchmarks/imagenet100/checkpoints/ijepa-vitb/ijepa-vitb-epoch=299.ckpt')
    ...
    for ckpt_path in ckpt_paths:
        ...
        logger = (
            WandbLogger(
                entity="stable-ssl",
                project="imagenet100-ijepa-probe",
                name=f"probe-inet100-ep{epoch_num:03d}-{time.time():.0f}",
                log_model=False,
            )
