...
from stable_ssl.tests.scripts.masking import MaskCollator
...
manager = ssl.Manager(trainer=trainer,
                      module=module,
                      data=data,
                      ckpt_path='/home/sky/stable-SSL/ijepa-cifar10/yxvs6tll/checkpoints/epoch=119-step=7320.ckpt',
)
